...
const FooterGithubIcon = (
	<svg aria-hidden="true" fill="currentColor" viewBox="0 0 1024 1024" className="h-5 w-5">
		<path
			fillRule="evenodd"
			clipRule="evenodd"
...
const FooterBlueskyIcon = (
	<svg aria-hidden="true" fill="currentColor" viewBox="0 0 256 226" className="h-5 w-5">
...
const FooterTwitterIcon = (
	<svg aria-hidden="true" fill="currentColor" viewBox="0 0 256 209" className="h-5 w-5">
